...
public interface ReservacionService extends CrudService<ReservacionRequest, ReservacionResponse> {
    ...
    void actualizarEstadoReservacion(Long idReservacion, Long codigoEstadoReservacion);

    boolean existeReservacionActivaPorHuesped(Long idHuesped);

    boolean existeReservacionActivaPorHabitacion(Long idHabitacion);
}